...
function lunaglowCheckFuture() {
    ...
    if (lunaglowHasCheckedFuture) {
        alert("Hey! You already saw your 

future. No peeking again!");
        return;
    }
    ...
    const girlFutures = [
        ...
        "You'll make a teddy bear that comes 

to life. Cuddly magic!",
...
document.querySelector('.lunaglow-crystal-ball');
    for (let i = 0; i < 50; i++) {
